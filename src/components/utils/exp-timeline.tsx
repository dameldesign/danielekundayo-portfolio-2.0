    ...
    return (
        <AnimationContainer className="w-full py-12 lg:py-16 space-y-10">
            ...
            <div className="relative">
                <div className="absolute inset-0 size-20 rounded-full bg-pink-600 blur-[5rem] -top-0.5 -left-2"></div>
                {children}
            </div>
    ...
    return (
        ...
        >
            <div className="relative">
                ...
                >
                    {active && (
                        <div className="top-0 left-0 w-4 h-4 rounded-full -z-10 bg-pink-600 animate-ping" />
                    )}
