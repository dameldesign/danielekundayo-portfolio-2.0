    ...
    <div className="w-full relative pb-20 py-10 z-40">
      ...
      >
        <motion.div
          ...
          className="bg-pink-500/10 hidden lg:block -z-10 w-[30rem] left-[-5rem] bottom-[8rem] absolute h-[18rem] blur-[10rem] rounded-full"
        />

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5 w-full">
          {/* Show only 4 projects (specifically projects 4-8 as in the original code) */}
