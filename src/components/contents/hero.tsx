    ...
    <div className="w-full relative pt-20 lg:pt-28 z-40" ref={ref}>
        ...
        <>
          ...
          <div className="text-balance relative z-20 mx-auto my-4 max-w-5xl text-center text-4xl lg:text-5xl font-bold">
            <motion.h2 className="text-balance !leading-snug">
              {"Crafting Scalable Web & Mobile Experiences That Drive Impact"
                .split(" ")
                .map((word, index) => (
                  <motion.span
                  ...
                  >
                    {word === "Scalable" ? (
                      <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#F40D44] to-pink-600">
                        {" "}
                        Scalable{" "}
                      </span>
                    ) : (
      ...
      >
        <p className="text-base text-muted-foreground !leading-relaxed">
          From high-performance web applications to cross-platform mobile
          solutions, I specialize in React, React Native, and intuitive UI/UX
          design.
          <span className="inline-blocklg:inline-block">
            {" "}
            Whether it's an e-commerce platform, a SaaS product, or a
            custom-built DApp, I deliver seamless, responsive, and SEO-optimized
            solutions that elevate your digital presence. Let’s build something
            exceptional in the current digital landscape.
          </span>
        </p>
      </AnimationContainer>
      ...
      >
        <Link href="#contact">
          <button className="relative py-3 text-[15px] tracking-wider font-medium overflow-hidden rounded-lg bg-[#f40d44] text-white transition-all duration-300 group btn-primary flex items-center justify-center w-52 h-auto">
              ...
              >
                <div className="flex flex-col items-center justify-center">
                  <div className="flex items-center justify-center">
                    ...
                    />
                    <span className="">
                      <PlusIcon className="size-6 text-pink-600" />
                    </span>
                  </div>
                </div>
