    ...
    return (
        <AnimatePresence>
            <motion.button
                ...
                className="relative py-3 text-[15px] tracking-wider font-medium overflow-hidden rounded-lg bg-[#F40D44] text-white transition-all duration-300 group btn-primary flex items-center justify-center w-48 h-auto mt-2"
            >
                <span className={cn(
